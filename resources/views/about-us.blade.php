        ...
        <div class="container mx-auto px-4 max-w-7xl relative z-10">
            <div class="max-w-3xl">
                ...
                <div class="flex gap-4">
                    ...
                    <a href="#story"
                       class="px-8 py-4 bg-white/10 backdrop-blur-sm hover:bg-white/20 text-white font-semibold rounded-lg transition-all border border-white/30">
                        Our Story
                    </a>
                </div>
            </div>
                ...
                <div class="grid md:grid-cols-2 gap-16 items-center">
                    <div>
                        ...
                        <div class="space-y-4 text-gray-700 text-lg leading-relaxed">
                            <p>
                                Fondazione Marcegaglia ETS Rwanda was founded in 2010 with a simple but powerful vision:
                                to create lasting positive change in the lives of Rwandan communities.
                            </p>
                            <p>
                                What began as a small initiative has grown into a comprehensive development
                                organization, touching thousands of lives through education, healthcare, and sustainable
                                community programs.
                            </p>
                            <p>
                                Our approach is rooted in partnership and respect. We work alongside local communities,
                                listening to their needs and empowering them to build their own solutions.
                            </p>
                        </div>
                    </div>
                    <div class="relative">
                ...
                <div class="grid md:grid-cols-2 gap-8">
                    ...
                    <div class="bg-white p-10 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
                        ...
                        <p class="text-gray-700 text-lg leading-relaxed">
                            To empower communities in Rwanda through sustainable development programs that provide
                            access to quality education, healthcare, and economic opportunities, fostering self-reliance
                            and lasting change.
                        </p>
                    </div>
                    ...
                    <div class="bg-white p-10 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
                        ...
                        <p class="text-gray-700 text-lg leading-relaxed">
                            A thriving Rwanda where every individual has the opportunity to reach their full potential,
                            and communities are equipped with the resources and knowledge to build prosperous,
                            sustainable futures.
                        </p>
                    </div>
                </div>
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <div class="group">
                        <div class="bg-gray-50 group-hover:bg-red-primary/5 p-8 rounded-xl transition-all h-full">
                            ...
                            <p class="text-gray-600 leading-relaxed">
                                We approach every interaction with empathy, treating each person with dignity and
                    ...
                    <div class="group">
                        <div class="bg-gray-50 group-hover:bg-red-primary/5 p-8 rounded-xl transition-all h-full">
                            ...
                            <p class="text-gray-600 leading-relaxed">
                                We work alongside communities, not for them. True change comes from collaboration and
                                mutual respect.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="group">
                        <div class="bg-gray-50 group-hover:bg-red-primary/5 p-8 rounded-xl transition-all h-full">
                            ...
                            <p class="text-gray-600 leading-relaxed">
                                Transparency and accountability are at the heart of everything we do. We honor the trust
                                placed in us.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="group">
                        <div class="bg-gray-50 group-hover:bg-red-primary/5 p-8 rounded-xl transition-all h-full">
                            ...
                            <p class="text-gray-600 leading-relaxed">
                                Every program is designed to create lasting impact, building systems that endure long
                                after we leave.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="group">
                        <div class="bg-gray-50 group-hover:bg-red-primary/5 p-8 rounded-xl transition-all h-full">
                            ...
                            <p class="text-gray-600 leading-relaxed">
                                We equip individuals with knowledge, skills, and resources to create their own
                                opportunities.
                            </p>
                        </div>
                    </div>
                    ...
                    @foreach ($teams as $team)
                        <div class="group">
                            <div class="aspect-square rounded-xl overflow-hidden mb-4 relative">
                                ...
                                <div
                                    class="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                    ...
                    <div>
                        ...
                        <p class="text-red-100">Kimaranzara Cell, Rilima Sector, Bugesera District, Eastern Rwanda as
                            FM ETS Rwanda country office via Giovanni della Casa, 12 – 20151 Milano, Italy</p>
                    </div>
                </div>
            </div>
        </div>
