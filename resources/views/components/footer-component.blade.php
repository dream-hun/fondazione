        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div class="lg:col-span-1">
                ...
                <div class="flex space-x-4">
                    <a href="#"
                       class="w-10 h-10 bg-white/10 hover:bg-amber-500 rounded-lg flex items-center justify-center transition-all duration-300 group">
                        <svg class="w-5 h-5 text-gray-300 group-hover:text-white transition-colors" fill="currentColor"
                             viewBox="0 0 24 24">
                            <path
                    ...
                    <a href="#"
                       class="w-10 h-10 bg-white/10 hover:bg-sky-500 rounded-lg flex items-center justify-center transition-all duration-300 group">
                        <svg class="w-5 h-5 text-gray-300 group-hover:text-white transition-colors" fill="currentColor"
                             viewBox="0 0 24 24">
                            <path
                    ...
                    <a href="#"
                       class="w-10 h-10 bg-white/10 hover:bg-pink-500 rounded-lg flex items-center justify-center transition-all duration-300 group">
                        <svg class="w-5 h-5 text-gray-300 group-hover:text-white transition-colors" fill="currentColor"
                             viewBox="0 0 24 24">
                            <path
                    ...
                    <a href="#"
                       class="w-10 h-10 bg-white/10 hover:bg-blue-600 rounded-lg flex items-center justify-center transition-all duration-300 group">
                        <svg class="w-5 h-5 text-gray-300 group-hover:text-white transition-colors" fill="currentColor"
                             viewBox="0 0 24 24">
                            <path
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="{{ route('home') }}"
                           class="text-gray-300 hover:text-primary transition-colors duration-200 flex items-center group">
            ...
            <div>
                ...
                <ul class="space-y-4">
                    ...
                    <li class="flex items-center space-x-3 text-gray-300">
                            ...
                            <span><a href="tel:+250 791 314 155">+250 791 314 155</a></span>
                    ...
                    <li class="flex items-center space-x-3 text-gray-300">
                        ...
                        <a href="mailto:info@fmorwanda.org"
                           class="hover:text-primary transition-colors">info@fmorwanda.org</a>
                    </li>
                </ul>
            </div>
        </div>
