                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select id="category"
                                    name="category"
                                    class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                <option value="cdsp" {{ old('category', $project->category->value) === 'cdsp' ? 'selected' : '' }}>CDSP</option>
                                <option value="wdp" {{ old('category', $project->category->value) === 'wdp' ? 'selected' : '' }}>WDP</option>
                            </select>
                            @error('category')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                    ...
                    <div x-data="{
                        ...
                        <template x-if="!previewUrl">
                            ...
                            >
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">{{ $project->featured_image_url ? 'Replaces current image.' : 'or click to browse' }}</p>
                            </div>
                        </template>
