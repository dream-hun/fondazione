...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Create New Notice</h1>
                <p class="text-gray-600 dark:text-gray-400 mt-1">Create and publish a new announcement or notice</p>
            </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <dd class="text-sm text-gray-900 dark:text-white font-mono">Auto-generated</dd>
                        </div>
                        
                        <div>
                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Created</dt>
                            <dd class="text-sm text-gray-900 dark:text-white">{{ now()->format('M j, Y g:i A') }}</dd>
                        </div>
                    </div>
                </div>
