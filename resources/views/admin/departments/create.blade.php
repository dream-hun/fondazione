...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Create New Department</h1>
                <p class="text-gray-600 dark:text-gray-400 mt-1">Add a new department to your organization</p>
            </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea id="mission" name="mission" rows="3"
                                ...
                                placeholder="Enter department mission...">{{ old('mission') }}</textarea>
                            @error('mission')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
