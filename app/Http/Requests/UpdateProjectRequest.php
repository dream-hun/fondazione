...
final class UpdateProjectRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'is_featured' => ['boolean'],
            'featured_image' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif,webp,avif', 'max:4096'],
            'gallery_images' => ['nullable', 'array'],
            'gallery_images.*' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif,webp,avif', 'max:4096'],
    ...
    public function messages(): array
    {
        return [
            ...
            'featured_image.max' => 'The featured image must not be larger than 4MB.',
            ...
            'gallery_images.*.max' => 'Each gallery image must not be larger than 4MB.',
            'slug.unique' => 'This slug is already in use.',
            'remove_gallery_images.array' => 'The selected gallery images must be provided as an array.',
            'remove_gallery_images.*.integer' => 'Each selected gallery image must reference a valid index.',
        ];
    }
